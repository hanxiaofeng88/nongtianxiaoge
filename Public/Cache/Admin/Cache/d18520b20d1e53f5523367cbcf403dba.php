                ...
                <table cellpadding="0" cellspacing="0" width="100%" >
                    <thead>
                        <tr class="ui-table-head">
                            ...
                            <th class="ui-table-hcell" width="40"><?php echo lang('package');?></th>
							<th class="ui-table-hcell" width="50"><?php echo lang('status');?></th>
							<th class="ui-table-hcell" width="55"><?php echo lang('自动发货');?></th>
                    ...
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="row-<?php echo ($vo["id"]); ?>">
                            ...
                            <td><?php echo (status($vo["is_auto_send"],"image")); ?></td>
                            <td class="action">
                                <a href="<?php echo U('Item/'.ACTION_NAME,array('do'=>'edit','id'=>$vo['id']));?>"><?php echo lang('edit');?></a> |
                                <a href="<?php echo U('Item/'.ACTION_NAME,array('do'=>'copy','id'=>$vo['id']));?>"><?php echo lang('copy');?></a> |
								<q onclick="using('<?php echo ($vo["id"]); ?>','<?php echo ($vo["name"]); ?>')"><?php echo lang('using');?></q>
                            </td>
