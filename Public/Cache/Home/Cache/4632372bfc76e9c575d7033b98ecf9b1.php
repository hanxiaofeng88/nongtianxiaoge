...
<div class="result">
	<h1><?php echo lang('order_submit_success');?></h1>
    <div class="innner">
        <div class="order" style="min-height: calc(100vh - 244px);">
            <div class="succtop">
				<span class="text"><?php echo lang('order_number_colon'); echo ($order["order_no"]); ?></span>
				<span style="margin-left:20px;"><?php echo lang('order_price_colon_symbol');?><b class="price"><?php echo ($order["total_price"]); ?></b></span>
			</div>
			<div class="succtop">
				<div class="qrcode"><img src="<?php echo (imageurl($qrcode)); ?>" ></div>
			</div>
        </div>
        <div class="foot">
            <a href="<?php echo ($order["url"]); ?>" class="foot_btn"><?php echo lang('goback');?></a>
...
seajs.use(['jquery'],function($){
	...
	$.ajax({ url:"<?php echo U('Api/send');?>",timeout:100,data:{order_id:order_id} });
});
</script>
